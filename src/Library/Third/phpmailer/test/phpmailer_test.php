...
class phpmailerTest extends TestCase
{
    ...
    function setUp() {
        ...
        $this->Mail->From = "antsnet@126.com";
        ...
        $this->Mail->Port = 25;
        $this->Mail->Helo = "smtp.163.com";
        $this->Mail->SMTPAuth = true;
        $this->Mail->Username = "antsnet";
        $this->Mail->Password = "119328118";
        $this->Mail->PluginDir = $INCLUDE_DIR;
		$this->Mail->AddReplyTo("antsent@163.com", "antsnet");
        $this->Mail->Sender = "jinhui.zhu@live.cn";
        ...
        else
        {
            ...
            $this->Sender = "jinhui.zhu@live.cn";
        }
    ...
    function CheckChanges() {
        ...
        if($this->Mail->Helo != "smtp.163.com")
    ...
    function test_Low_Priority() {
        ...
        $this->Mail->AddReplyTo("jinhui.zhu@live.cn", "Nobody (Unit Test)");
